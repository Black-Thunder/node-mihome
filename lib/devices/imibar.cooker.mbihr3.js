...
module.exports = class extends Device {
	...
	getRemainingRice() {
		...
		if (remainingRice) {
			return codeToNum(remainingRice) * 5;
		}
		return undefined;
	}
	...
	getPalate() {
		...
		if (palate === 2) {
			return "Thick porridge";
		}
		if (palate === 3) {
			return "Baby porrridge";
		}
		if (palate === 4) {
			return "GD porrridge";
		}
		if (palate === 6) {
			return "Sweet cooking";
		}
		if (palate === 8) {
			return "Claypot rice";
		}
	...
	getSeed() {
		...
		if (seed === 2) {
			return "Long grain rice";
		}
		if (seed === 3) {
			return "Thai rice";
		}
		if (seed === 4) {
			return "Daohuaxiang rice";
		}
		if (seed === 5) {
			return "Wuchang rice";
		}
		if (seed === 6) {
			return "Coarse Cereals";
		}
		return undefined;
	}
	...
	getCook() {
		...
		if (cook === 3) {
			return "Steamed dumplings";
		}
		if (cook === 4) {
			return "Steamed fish";
		}
		if (cook === 5) {
			return "Steamed pork ribs";
		}
		if (cook === 6) {
			return "Steamed sweet potato";
		}
		if (cook === 7) {
			return "Steamed corn";
		}
		if (cook === 8) {
			return "Rice dumpling(water)";
		}
		if (cook === 9) {
			return "Dumpling(water)";
		}
		if (cook === 10) {
			return "Noodles(water)";
		}
		if (cook === 11) {
			return "Rice noodles(water)";
		}
		if (cook === 12) {
			return "Make cakes";
		}
	...
	getError() {
		...
		if (error) {
			return codeToNum(error);
		}
		return undefined;
	}

	setRice(_palate, _seed, _size, _grain, _cup, _allow, _hours, _minutes, _wash) {
