...
module.exports = class extends Device {
	...
	static image =
		"https://cdn.cnbj1.fds.api.mi-img.com/iotweb-product-center/developer_1592882758857aFAwK57c.png?GalaxyAccessKeyId=AKVGLQWBOVIRQ3XLEW&Expires=9223372036854775807&Signature=Qd2GmopLgi0nbX+mjrm1DH2z++A=";
	...
	setMode(v) {
		if (v === "dry") {
			...
			v = 0;
		} else if (v === "antifreeze") {
			v = 0;
		} else if (v === "programming") {
			v = 0;
		} else {
			return Promise.reject(new Error(`Mode ${v} is not supported`));
		}
